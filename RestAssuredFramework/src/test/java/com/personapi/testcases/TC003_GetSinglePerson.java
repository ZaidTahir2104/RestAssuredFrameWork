...
public class TC003_GetSinglePerson extends TestBase {
	
	
	@BeforeClass
	public void getPerson() throws InterruptedException {
		logger.info("***************** Started TC003_GetSinglePersonDetail **************");
		RestAssured.baseURI = "http://localhost:3000/";
		RequestSpecification httprequest = RestAssured.given();
		System.out.print("Person ID is "+personID);
		response = httprequest.request(Method.GET,"/persons/"+personID);
		//Thread.sleep(5000);
		}
	@Test
	public void checkResponseBody(){
		...
		AssertJUnit.assertTrue(responseBody.contains(personID));
	}
	@Test
	...
	public void tearDown() {
		logger.info("***************** Finished TC003_GetSinglePersonDetail **************");
	}
}
